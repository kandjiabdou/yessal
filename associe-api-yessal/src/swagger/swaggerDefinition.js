      ...
      UserCreate: {
        ...
        properties: {
          ...
          siteLavagePrincipalGerantId: {
            type: 'integer',
            description: 'Primary laundry site ID (only for Associe role)',
          },
        },
      },
      UserUpdate: {
        ...
        properties: {
          ...
          typeClient: {
            ...
            description: 'Client type (only for Client role, can only be updated by Associe)',
          },
          siteLavagePrincipalGerantId: {
            type: 'integer',
            description: 'Primary laundry site ID (only for Associe role, can only be updated by Associe)',
          },
        },
      },
      Login: {
      ...
      OrderCreate: {
        ...
        properties: {
          ...
          masseVerifieeKg: {
            type: 'number',
            minimum: 6,
            description: 'Verified weight in kg (typically set by associe)',
          },
          formuleCommande: {
            type: 'string',
      ...
      OrderUpdate: {
        ...
        properties: {
          ...
          gerantReceptionUserId: {
            type: 'integer',
            description: 'Receiving associe ID',
          },
          modePaiement: {
            type: 'string',
