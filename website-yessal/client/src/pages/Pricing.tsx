  ...
  return (
    <>
      ...
      <section id="tarifs" className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            className="p-4 md:p-6 rounded-xl shadow-md text-center mb-8"
            ...
            {pricingItems.map((item, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-4 justify-center">
                  <h1 className="text-3xl font-bold text-center self-center">{item.weight}</h1>
                  {item.badge && (
                    <span
                ...
                {item.supplement && (
                  <div className="mt-2 p-2 rounded-md flex flex-col gap-1" style={{ backgroundColor: "#e8f5e9", borderLeft: "3px solid #00bf63" }}>
                    <span 
                    ...
                    <p className="text-center text-xs" style={{ color: "#1a73e8" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            ...
            >
              <div className="text-center">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <p>• Paiement selon machine utilisée</p>
                  <p>• Séchage, repassage, livraison</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <p>• Lavage + Séchage inclus</p>
                  <p>• Repassage inclus</p>
            ...
            >
              <div className="text-center">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <p>• Tous services inclus</p>
                  <p>• Options supplémentaires incluses</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section id="tarifs" className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            className="bg-gray-50 p-4 md:p-6 rounded-xl shadow-md text-center mt-8 md:mt-12 max-w-4xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
