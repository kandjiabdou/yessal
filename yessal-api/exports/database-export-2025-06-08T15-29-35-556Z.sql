...
INSERT INTO `User` (`id`, `role`, `nom`, `prenom`, `email`, `telephone`, `motDePasseHash`, `loginGoogleId`, `adresseText`, `latitude`, `longitude`, `aGeolocalisationEnregistree`, `typeClient`, `estEtudiant`, `siteLavagePrincipalGerantId`, `createdAt`, `updatedAt`) VALUES
  (1, 'Manager', 'Ndoye', 'Serigne', 'serigne.ndoye@example.sn', '+221770122430', '$2b$10$ugrH42esCN22wuBRgld1o.sqCdM/.j562Ko5rsLsZjm0G5/8NgjLu', NULL, 'Rue 140 Louga', 15.03981, -16.409089, 1, NULL, 0, 1, '2025-05-22 19:51:29', '2025-06-01 19:27:49'),
...
INSERT INTO `ClientInvite` (`id`, `nom`, `telephone`, `email`) VALUES
  (1, 'Client sans compte', NULL, NULL),
  (2, 'Diop Seynabou', NULL, NULL),
  (3, 'Client sans compte', NULL, NULL),
  (4, 'TALL Fatou', NULL, NULL);
SET FOREIGN_KEY_CHECKS = 1;
...
INSERT INTO `AbonnementPremiumMensuel` (`id`, `clientUserId`, `annee`, `mois`, `limiteKg`, `kgUtilises`, `createdAt`, `updatedAt`) VALUES
  ...
  (4, 21, 2025, 5, 40, 48, '2025-05-22 19:51:30', '2025-05-22 19:51:30');
SET FOREIGN_KEY_CHECKS = 1;
