...
model FluxFinancier {
  ...
  // Type de flux
  type                FluxFinancierType   @default(depense)
  // Manager: depense, recette
  // Associé: depense, recette, emprunt, pret
  ...
  dateEcheance        DateTime?           // Pour prêts/emprunts
  ...
  beneficiaire        String?
  description         String?
  preuveUrl           String?             // URL vers la preuve
  ...
  validatedBy         String?             // Associé ID
  
  // Autres
  actionnaire         String?             // Pour prêts/emprunts
